...
def info_page():
    st.title("Info Page")
    st.header("About the Model - I am currently experiencing technical issues uploading more detailed description of the model, as well as a better version of the model itself, update is planned for 13.08.2023")
